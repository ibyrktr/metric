 ...
 *
 */
@Table(name = "hourly_metric_event_by_group", keyspace = "metric")
public class HourlyMetricStatsByGroup extends DailyMetricStatsByGroup implements Serializable {
	...
	public static transient StructType schema = new StructType().add("group", DataTypes.StringType, true)
			...
			.add("day", DataTypes.IntegerType, true).add("hour", DataTypes.IntegerType, true)
