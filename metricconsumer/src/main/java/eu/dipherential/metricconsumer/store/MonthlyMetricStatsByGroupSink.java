 ...
 * @author bayrak
 */
public class MonthlyMetricStatsByGroupSink extends ForeachWriter<MonthlyMetricStatsByGroup> {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6423517179793726522L;
	...
	private Mapper<MonthlyMetricStatsByGroup> map;
	private Session session;

	public MonthlyMetricStatsByGroupSink() {
		super();
	}
	...
	public boolean open(long l, long l1) {
		...
		map = manager.mapper(MonthlyMetricStatsByGroup.class);
		return true;
	}

	@Override
	public void process(MonthlyMetricStatsByGroup m) {
		map.save(m);
