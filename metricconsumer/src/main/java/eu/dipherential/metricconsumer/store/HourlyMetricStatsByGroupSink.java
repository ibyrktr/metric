 ...
 * @author bayrak
 */
public class HourlyMetricStatsByGroupSink extends ForeachWriter<HourlyMetricStatsByGroup> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 971647541353795268L;
	...
	private Mapper<HourlyMetricStatsByGroup> map;
	private Session session;

	public HourlyMetricStatsByGroupSink() {
		super();
	}
	...
	public boolean open(long l, long l1) {
		...
		map = manager.mapper(HourlyMetricStatsByGroup.class);
		return true;
	}

	@Override
	public void process(HourlyMetricStatsByGroup m) {
		map.save(m);
