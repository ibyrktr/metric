 ...
 * @author bayrak
 */
public class MonthlyMetricStatsByIdSink extends ForeachWriter<MonthlyMetricStatsById> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5689806416823272971L;
	/**
	 * 
	 */
	...
	private Mapper<MonthlyMetricStatsById> map;
	private Session session;

	public MonthlyMetricStatsByIdSink() {
		super();
	}
	...
	public boolean open(long l, long l1) {
		...
		map = manager.mapper(MonthlyMetricStatsById.class);
		return true;
	}

	@Override
	public void process(MonthlyMetricStatsById m) {
		map.save(m);
