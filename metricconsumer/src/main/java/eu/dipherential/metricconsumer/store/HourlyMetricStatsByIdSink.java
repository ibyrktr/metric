 ...
 * @author bayrak
 */
public class HourlyMetricStatsByIdSink extends ForeachWriter<HourlyMetricStatsById> {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6894314699189642238L;
	...
	private Mapper<HourlyMetricStatsById> map;
	private Session session;

	public HourlyMetricStatsByIdSink() {
		super();
	}
	...
	public boolean open(long l, long l1) {
		...
		map = manager.mapper(HourlyMetricStatsById.class);
		return true;
	}

	@Override
	public void process(HourlyMetricStatsById m) {
		map.save(m);
